...
function comprar(){
    ...
    pizza.setAttribute('src','https://github.com/leandrobranco/JavaScript/blob/master/function/img/8.jpg')
...
function comer(n){
       ...
       if(n >0){
            --n
            pizza.setAttribute('src',`https://github.com/leandrobranco/JavaScript/blob/master/function/img/${n}.jpg`)
